...
const PLAN_SPECS=[
  {path:path.resolve("content/reviews/math-a/12/12-complete.review-plan.json"),year:"12.º",expectedSubtopics:40,expectedQuestions:2000},
  {path:path.resolve("content/reviews/math-a/12/12-optional-complex.review-plan.json"),year:"12.º opcional",expectedSubtopics:7,expectedQuestions:350}
];
...
console.log(`✓ 12.º ano fechado no gate interno: 40 regulares + 7 opcionais · ${EXPECTED_SUBTOPICS}/${EXPECTED_SUBTOPICS} submatérias · ${EXPECTED_QUESTIONS}/${EXPECTED_QUESTIONS} perguntas · 0 por resolver`);
