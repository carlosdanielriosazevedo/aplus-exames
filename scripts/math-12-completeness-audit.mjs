...
const PLAN_SPECS=[
  {path:path.resolve("content/reviews/math-a/12/12-complete.review-plan.json"),year:"12.º",expectedSubtopics:32,expectedQuestions:1600},
  {path:path.resolve("content/reviews/math-a/12/12-optional-complex.review-plan.json"),year:"12.º opcional",expectedSubtopics:15,expectedQuestions:750}
];
...
console.log(`✓ 12.º ano fechado no gate interno: 32 regulares + 15 opcionais · ${EXPECTED_SUBTOPICS}/${EXPECTED_SUBTOPICS} submatérias · ${EXPECTED_QUESTIONS}/${EXPECTED_QUESTIONS} perguntas · 0 por resolver`);
