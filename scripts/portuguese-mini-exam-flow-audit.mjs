...
assert.match(page,/portuguese-639-passage-prototypes\.json/u,"o fluxo principal deve consumir o documento canónico de textos partilhados");
assert.match(page,/buildPortuguesePassagePrototypeExam/u,"o fluxo principal deve construir o mini-exame com o builder canónico");
...
console.log("✓ fluxo Mini-exame Português: integrado no router interno · acesso pelo laboratório · área Exames preparada por disciplina · Português continua bloqueado em foundation · respostas abertas sem nota automática");
