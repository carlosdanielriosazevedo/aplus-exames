...
assert.equal(CONSTRUCTED_RESPONSE_BANK.length,41,"A matriz adversarial deve cobrir as 41 respostas construídas reais.");
...
console.log(`✓ adversarial constructed responses: ${checked} cenários base + ${conflicts} contradições explícitas cobrem 41/41 perguntas sem pontuação indevida nem contaminação de Domínio/Certeza`);
