...
assert.equal(PORTUGUESE_ITEMS.length,225,"O runtime de Português deve carregar os 225 itens foundation.");
assert.equal(new Set(PORTUGUESE_ITEMS.map(item=>item.id)).size,225,"Os IDs devem ser únicos.");
...
console.log("✓ Portuguese quality gate: 225 itens · 3 anos · 4 domínios escritos · evidência por critério sem nota final automática");
