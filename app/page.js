...
function PortugueseLab({s,setS,go}){
  ...
  function recordRubricEvidence(criterionId,evidence){
    const nextFeedback=assessPortugueseRubricCriterion(feedback,criterionId,evidence);
