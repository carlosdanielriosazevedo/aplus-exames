...
export default function StudentScreens({s,setS,screen,go,trainingCfg,setTrainingCfg,examSession,setExamSession,recoveredSession,setRecoveredSession,initial}){
