// APProva+ v2.4 — domínio de identidade e permissões
// A autenticação real será delegada ao Neon Auth.
// Este módulo contém apenas regras de negócio da APProva+ (roles, ligações, convites).
...
export function demoIdentity(role="student"){
  const profiles={
    ...
    admin:{displayName:"Admin APProva+",email:"admin.demo@aplus.local",roles:["admin"]}
  };
